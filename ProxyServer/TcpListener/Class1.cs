...
namespace System.Net.Sockets
{
    public class TcpListener1
    {
        ...
        public TcpListener1(IPEndPoint localEP)
        {
        ...
        // and port.
        public TcpListener1(IPAddress localaddr, int port)
        {
        ...
        internal TcpClient EndAcceptTcpClient(IAsyncResult asyncResult)
        {
            ...
            return new TcpClient(socket.LocalEndPoint.AddressFamily);
        }

        public Task<Socket> AcceptSocketAsync()
        {
            return Task<Socket>.Factory.FromAsync(
                (callback, state) => ((TcpListener1)state).BeginAcceptSocket(callback, state),
                asyncResult => ((TcpListener1)asyncResult.AsyncState).EndAcceptSocket(asyncResult),
                state: this);
        }
        ...
        public Task<TcpClient> AcceptTcpClientAsync()
        {
            return Task<TcpClient>.Factory.FromAsync(
                (callback, state) => ((TcpListener1)state).BeginAcceptTcpClient(callback, state),
                asyncResult => ((TcpListener1)asyncResult.AsyncState).EndAcceptTcpClient(asyncResult),
                state: this);
        }
    }
}
